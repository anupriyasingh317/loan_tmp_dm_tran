CREATE OR REPLACE PACKAGE BODY loan AS
    PROCEDURE loan(
    ...
    BEGIN
        ...
        SELECT ldms.bch_id, 
               ...
               decode(nvl(ldms.acp_tran_st_cd, pkg_zacp_tran_st.gl_cpld), 
                      ...
                      nvl(ldms.acp_tran_st_cd, pkg_zacp_tran_st.gl_cpld)) acp_tran_st_cd, 
               ...
               CASE 
                 ...
                 THEN l_mthy_aa_sa_smry_pdcs_id 
